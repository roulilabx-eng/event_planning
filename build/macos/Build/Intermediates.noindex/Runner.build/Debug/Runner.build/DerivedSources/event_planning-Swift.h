...
#ifndef EVENT_PLANNING_SWIFT_H
#define EVENT_PLANNING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="event_planning",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14event_planning11AppDelegate")
...
SWIFT_CLASS("_TtC14event_planning17MainFlutterWindow")
